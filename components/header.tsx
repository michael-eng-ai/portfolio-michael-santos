  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b border-gray-200/50 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 lg:h-20 lg:px-6">
        <Link href={localePath(locale)} className="shrink-0 text-lg font-black uppercase tracking-tighter text-gray-900 lg:text-xl">
          {siteConfig.name}
        </Link>
        ...
        <div className="flex shrink-0 items-center gap-2 lg:gap-4">
          ...
          <Link
            ...
            className="brand-button-primary hidden px-6 py-2.5 text-sm font-bold tracking-tight lg:inline-flex"
          >
